...
🩸 Developing **RedHope**, a blood donation platform connecting patients with compatible donors during emergencies.<br>
<br>
-🤝 Enabling volunteers and donors to contribute to life-saving efforts.<br>
-💳 Integrating Stripe for smooth and secure payment processing.<br>
-📝 Managing donor requests, and allowing volunteers and admins to handle all requests and update statuses efficiently.<br>
-📄 Developed features like blood card creation/download, eligibility checks, direct email messaging, and user reviews.<br>
-⚙️ Tech Stack: React, React Query, Tailwind CSS, Node.js, Express.js, MongoDB, JWT, Firebase, Stripe, EmailJS.<br>
...
![ShadCN](https://img.shields.io/badge/shadcn-%235A0EF8.svg?style=for-the-badge&logo=shadcn&logoColor=white) 
